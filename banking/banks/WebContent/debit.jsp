  ...
  Connection con = null;
   try{
	...
	try{ 
		...
		String sqlStatement = "select phone,balance from manager1 where acc_no='"+ac+"'";
			...
			out.println("amount credited");
					   ...
					   /* Find your sid and token at twilio.com/user/account */
					    ...
					    String AUTH_TOKEN = "ccd46cf6b12635a59709f94ef2cee1c2";
					        ...
					        params.add(new BasicNameValuePair("Body", "dear customer, your account has been debited with rs."+d+".your available balance is"+bl1+".have a nice day"));
